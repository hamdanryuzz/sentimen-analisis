...
# pies= plt.pie(tb_counts_ganjar.values, labels=tb_counts_ganjar.index, explode=(0,0,0.25), autopct='%1.1f%%', shadow=False)

# sl.write(piee)
#membuat diagram pie dengan hasil analisis
